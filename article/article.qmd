...
First and foremost, since replicator selection (see @sec-review-language-change-entrenchment) is *always* assumed to be at play, the innovative construction will always become dominant over time. The influence of priming can be estimated by comparing the evolution of the base rate across agents in simulations *without* priming ("entrenchment") and *with* priming. From @dekker_conversational_2024, priming is expected to accelerate the dominance of the innovative construction.
