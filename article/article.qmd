...
In the second step, the speaker now has to choose one of the two constructions of the alternation to utter to the hearer. The probability of choosing either construction is computed by normalising their activation levels, according to @eq-normalisation. Because replicator selection is active -- the innovative variant has an advantage over the older variant -- we add a bias activation value $\gamma$ to the innovative's variant activation level before normalisation.
$$
