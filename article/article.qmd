...
![Evolution of the median base rate across agents for different frequencies and replicator selection strengths, for the model with the inverse frequency effect. This model was allowed to run for longer.](figures/fig-with-inverse-frequency-long-ctx_base_rate_mean.png){#fig-with-inverse-frequency-long-ctx_base_rate_mean}
