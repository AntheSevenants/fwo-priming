...
### Without the inverse frequency effect
...
### With the inverse frequency effect
...
We again also show the effect of varying decay rate of the priming effect. @fig-todo shows that, as decay rate becomes smaller, the ceiling where propagation stalls for a high-frequency alternation becomes lower. This is again to be expected: as priming becomes more effective, i.e. lasts longer, the inverse frequency effect becomes stronger, and replicator selection has even less of an impact.

## Discussion

cumulativity = een combinatie van priming opportunity EN decay rate
